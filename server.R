...
shinyServer(function(input, output) {
  ...
  output$plot1 <- renderPlot({
    ...
    legend(70, 100, c("Model 1 Prediction", "Model 2 Prediction"), pch = 16, 
           col = c("green", "orange"), bty = "n", cex = 1.2)
    
    points(agricultureInput, model1pred(), col = "green", pch = 16, cex = 2)
    
    points(examinationInput, model2pred(), col = "orange", pch = 16, cex = 2)
  })
